...
{
  print('There are records from the year 2002!!!')
  }else{
    print('There are no records from the year 2002 :(')
    }
```
...
{
  print('There are records from the year 2012!!!')
  }else{
    print('There are no records from the year 2012 :(')
    }
```
...
for(i in levels(gapminder$continent))
{
  ...
  if(mean_lifeExp >= 50)
  {
    paste(i, 'Mean life expectancy is greater than or equal to 50 years old!') %>%
    print()
  }else{
    paste(i, 'Mean life expectancy is less than 50 years old :(') %>%
    print()
  }
}
```
...
for(i in levels(gapminder$country))
{
  ...
  if(mean_lifeExp < 50)
  {
    ...
    paste(i, 'Mean life expectancy is between than 50 and 70 years old :|') %>%
      print()
  }else{  
    paste(i, 'Mean life expectancy is greater than 70 years old! :)') %>%
      print()
  }
}
```
